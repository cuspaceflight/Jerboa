...
/* FRR Modes ----------------------------------------------------------------*/
#define EZRP_FRR_DISABLED                           (0)
#define EZRP_FRR_INT_STATUS                         (1)
#define EZRP_FRR_INT_PEND                           (2)
#define EZRP_FRR_INT_PH_STATUS                      (3)
#define EZRP_FRR_INT_PH_PEND                        (4)
#define EZRP_FRR_INT_MODEM_STATUS                   (5)
#define EZRP_FRR_INT_MODEM_PEND                     (6)
#define EZRP_FRR_INT_CHIP_STATUS                    (7)
#define EZRP_FRR_INT_CHIP_PEND                      (8)
#define EZRP_FRR_CURRENT_STATE                      (9)
#define EZRP_FRR_LATCHED_RSSI                       (10)
...
#define EZRP_GPIO_PIN_CFG_GEN_CONFIG_DRV_STRENGTH_MED_HIGH  (1<<5)
#define EZRP_GPIO_PIN_CFG_GEN_CONFIG_DRV_STRENGTH_LED_LOW   (2<<5)
#define EZRP_GPIO_PIN_CFG_GEN_CONFIG_DRV_STRENGTH_LOW       (3<<5)
